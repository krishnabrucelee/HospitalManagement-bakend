...
public class ScheduleDao {
	...
	public JSONObject generateNurseSchedule(JSONObject scheduleInformations) {
		...
		try {
		    ...
		    Map<String, Object> SchedulingPeriod = (Map<String, Object>) scheduleInformations.get("SchedulingPeriod");
		    
		    Map<String, Object> Employees = (Map<String, Object>) SchedulingPeriod.get("Employees");
		    
		    List<LinkedHashMap<String,Object>> defaultEmployeeList = (List<LinkedHashMap<String, Object>>) Employees.get("Employee");
